defmodule BotArmyMcp.ExampleTest do
  @moduledoc """
  ...
  describe "module initialization" do
    test "application starts without errors" do
      assert BotArmyMcp.Application != nil
    end
  end
  ...
  describe "pulse publisher" do
    test "pulse publisher module exists" do
      ...
      assert module_exists?(BotArmyMcp.PulsePublisher)
    end
  end
  ...
  describe "http client behavior" do
    test "http client behavior is defined" do
      ...
      assert module_exists?(BotArmyMcp.HTTPClient)
      assert module_exists?(BotArmyMcp.HTTPClient.Req)
    end
  end
