defmodule BotArmyMcp.Skills.Example do
  @moduledoc """
  Example skill for MCP Bot.
  ...
  1. NATS message arrives on trigger subject: `bot.bot_army_mcp.command.example`
  ...
  5. Result published to response subject: `bot.bot_army_mcp.response.<request_id>`
  ...
  1. Rename: `lib/bot_army_mcp/skills/your_skill.ex`
  ...
  def nats_triggers do
    ...
    [
      "bot.bot_army_mcp.command.example"
    ]
  end
